...
-- CreateEnum
CREATE TYPE "ExamAnswer" AS ENUM ('VARIANT_A', 'VARIANT_B', 'VARIANT_C', 'VARIANT_D');
...
-- AddForeignKey
ALTER TABLE "StudentExamQuestion" ADD CONSTRAINT "StudentExamQuestion_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
